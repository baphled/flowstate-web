...
describe('ToastContainer', () => {
  ...
  it('applies variant class to toast item', async () => {
    ...
    expect(qs('[data-testid="toast-item"]')!.classList.contains('toast-item--error')).toBe(true)
  })
  ...
  it('applies default variant class when no variant specified', async () => {
    ...
    expect(qs('[data-testid="toast-item"]')!.classList.contains('toast-item--default')).toBe(true)
  })
  ...
  it('applies success variant class', async () => {
    ...
    expect(qs('[data-testid="toast-item"]')!.classList.contains('toast-item--success')).toBe(true)
  })
  ...
  it('applies loading variant class', async () => {
    ...
    expect(qs('[data-testid="toast-item"]')!.classList.contains('toast-item--loading')).toBe(true)
  })
