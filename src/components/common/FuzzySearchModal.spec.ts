...
describe("FuzzySearchModal", () => {
  ...
  it("renders nothing when open is false", () => {
    ...
    expect(wrapper.find('[data-testid="fuzzy-search-modal"]').exists()).toBe(
      false,
    );
  });
  ...
  it("renders the modal overlay when open is true", () => {
    ...
    expect(wrapper.find('[data-testid="fuzzy-search-backdrop"]').exists()).toBe(
      true,
    );
    expect(wrapper.find('[data-testid="fuzzy-search-input"]').exists()).toBe(
      true,
    );
  });
  ...
  it("renders group headers when items have groups", () => {
    ...
    expect(
      wrapper.find('[data-testid="fuzzy-search-group-Anthropic"]').exists(),
    ).toBe(true);
    expect(
      wrapper.find('[data-testid="fuzzy-search-group-OpenAI"]').exists(),
    ).toBe(true);
  });
  ...
  it("shows empty message when no results match", async () => {
    ...
    expect(wrapper.find('[data-testid="fuzzy-search-empty"]').exists()).toBe(
      true,
    );
    expect(wrapper.find('[data-testid="fuzzy-search-empty"]').text()).toContain(
      "Nothing found",
    );
  });
  ...
  it("emits close when backdrop is clicked", async () => {
    ...
    await wrapper
      .find('[data-testid="fuzzy-search-backdrop"]')
      .trigger("click");
